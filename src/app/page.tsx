                ...
                >
                  ...
                  <div className="relative bg-black/40 backdrop-blur-sm rounded-xl p-6 border border-red-500/40 dark:border-white/10">
                    <p className="text-lg md:text-xl text-white/90 leading-relaxed">
                      EqualRise is an interactive platform offering four powerful modes for promoting equality and inclusion. Through gamified learning, trivia competitions, skill sharing, and impact tracking, we align with{" "}
                      <motion.span
