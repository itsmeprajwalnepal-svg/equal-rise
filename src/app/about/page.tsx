        ...
        <div className="max-w-7xl mx-auto space-y-16 mb-16">
          ...
          <section className="text-center space-y-6">
            ...
            >
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-orange-400">EqualRise</span>
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              A comprehensive platform developed for the CFC Hackathon, focusing on SDG 5 (Gender Equality) and SDG 10 (Reduced Inequalities) through interactive learning and community engagement.
            </motion.p>
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <p className="text-foreground/80">
                  EqualRise was created as part of the CFC Hackathon. Our platform serves as a bridge between technology and social impact, offering innovative solutions for promoting equality and inclusion.
                </p>
                <p className="text-foreground/80">
              ...
              <div className="bg-gradient-to-br from-red-500/10 to-orange-500/10 rounded-xl p-6 border border-red-500/20">
                <h3 className="text-lg font-semibold text-foreground mb-4">Why EqualRise?</h3>
                ...
                <div className="relative h-full backdrop-blur-xl bg-gradient-to-br from-red-500/10 via-rose-500/5 to-red-400/10 rounded-2xl p-8 border border-red-200/20 shadow-xl hover:shadow-2xl transition-all duration-300">
                  ...
                  <div className="relative flex flex-col items-center">
                    <div className="w-32 h-32 rounded-full overflow-hidden mb-6 ring-2 ring-red-200/30 ring-offset-2 ring-offset-white/10">
                      <img 
                        src="/ssb.jpg" 
                        alt="Sanish Sagar Bhandari"
                        className="w-full h-full object-cover object-[center_16%]"
                      />
                    </div>
                    <h3 className="text-2xl font-bold text-foreground mb-1">Sanish Sagar Bhandari</h3>
                    ...
                    <div className="space-y-4 text-center">
                      <p className="text-foreground/70 text-sm italic">
                        "+2 Passout with Science Background , AI enthusiast, and tech innovator."
                      </p>
                      <div className="pt-4 border-t border-red-200/20">
                        <p className="font-semibold text-foreground mb-2">Contribution to EqualRise:</p>
              ...
              <div className="group">
                <div className="relative h-full backdrop-blur-xl bg-gradient-to-br from-red-500/10 via-rose-500/5 to-red-400/10 rounded-2xl p-8 border border-red-200/20 shadow-xl transition-all duration-300">
                  ...
                  <div className="relative flex flex-col items-center">
                    ...
                    <h3 className="text-2xl font-bold text-foreground mb-1">Yunesh Lama</h3>
                    ...
                    <div className="space-y-4 text-center">
                      <p className="text-foreground/70 text-sm italic">
                        "Currently pursuing a degree in BSc IT at Techspire, passionate about coding and technology."
                      </p>
                      <div className="pt-4 border-t border-red-200/20">
                        <p className="font-semibold text-foreground mb-2">Contribution to EqualRise:</p>
                        <div className="text-sm text-foreground/70 space-y-1">
          ...
          {/* CFCConnection Section */}
          <section className="relative backdrop-blur-md bg-transparent rounded-xl p-8 border border-gray-200 dark:border-white/10">
            <h2 className="text-2xl font-semibold text-foreground mb-6">CFCHackathon Connection</h2>
            <div className="space-y-4">
              <p className="text-foreground/80">
                EqualRise was developed as part of the Code For Change Hackathon, focusing specifically on UN SDGs 5 and 10. The platform demonstrates how technology can be used to address social challenges while providing educational resources and practical tools for organizations and individuals committed to creating a more equitable world.
              </p>
